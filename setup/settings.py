...
Migração EuropaNew VDF → Django + PostgreSQL + WeasyPrint
"""
...
CSRF_TRUSTED_ORIGINS = config('CSRF_TRUSTED_ORIGINS', default='http://127.0.0.1', cast=lambda v: [s.strip() for s in v.split(',')])
...
MIDDLEWARE = [
    ...
    'core.middleware.EmpresaObrigatoriaMiddleware',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='europa_db'),
